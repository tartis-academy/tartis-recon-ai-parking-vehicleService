...
class VehicleTest {
        ...
        // @Test: Indica a JUnit que este metodo es una prueba unitaria individual que
        // debe ejecutarse.
        @Test
        ...
        void shouldCreateValidCar() throws InvalidVehicleException {
                ...
                Vehicle vehicle = Vehicle.create(VehicleType.CAR, "1234BCD", "Toyota", "Corolla", "Red", 5, false,
                                true);
                ...
                // assertThat: Compara el valor real (obtenido del getter) con el valor esperado
                // usando isEqualTo.
        ...
        void shouldCreateValidMotorbike() throws InvalidVehicleException {
                // QUE HACE:
                // Instancia dos objetos de tipo MOTORBIKE con 0 puertas: uno con sidecar y otro
                // sin sidecar.
                Vehicle motorbikeWithSidecar = Vehicle.create(VehicleType.MOTORBIKE, "5678DFG", "Honda", "CBR", "Black",
                                0, true, true);
                Vehicle motorbikeWithoutSidecar = Vehicle.create(VehicleType.MOTORBIKE, "5678DGH", "Honda", "CBR",
                                "Black", 0, false, true);
        ...
        void shouldThrowExceptionWhenCarHasSidecar() {
                ...
                // QUE DEBERIA HACER:
                // Debe fallar y lanzar InvalidVehicleException, ya que las reglas de negocio de
                // dominio
                // prohiben que los coches tengan sidecar. El mensaje de la excepcion debe
                // indicar esto.

                // assertThatThrownBy: Captura la excepcion que lance la expresion lambda.
                // isInstanceOf: Valida que la excepcion capturada sea exactamente de la clase
                // indicada.
                // hasMessageContaining: Valida que el mensaje de error de la excepcion tenga
                // ese fragmento de texto.
                assertThatThrownBy(() -> Vehicle.create(VehicleType.CAR, "1234BCD", "Toyota", "Corolla", "Red", 4, true,
                                true))
                                .isInstanceOf(InvalidVehicleException.class)
                                .hasMessageContaining("Cars do not have sidecar");
        }

        // @ParameterizedTest: Indica a JUnit que esta prueba se ejecutara varias veces
        // usando
        // diferentes entradas (parametros) suministradas por un proveedor de datos.
        // @ValueSource: Proveedor de datos que pasa una lista de valores simples (en
        // este caso enteros)
        ...
        void shouldThrowExceptionWhenCarHasInvalidDoors(int doors) {
                // QUE HACE:
                // Intenta crear un coche (CAR) utilizando numeros de puertas no validos (1, 3,
                // 6).
                // QUE DEBERIA HACER:
                ...
                assertThatThrownBy(
                                () -> Vehicle.create(VehicleType.CAR, "1234BCD", "Toyota", "Corolla", "Red", doors,
                                                false, true))
                                .isInstanceOf(InvalidVehicleException.class)
        ...
        void shouldThrowExceptionWhenDoorsAreNegative() {
                ...
                // QUE DEBERIA HACER:
                // Debe lanzar InvalidVehicleException indicando que el numero de puertas no
                // puede ser negativo,
                // validandose en el primer paso de comprobacion de puertas.
                assertThatThrownBy(() -> Vehicle.create(VehicleType.CAR, "1234BCD", "Toyota", "Corolla", "Red", -1,
                                false, true))
                                .isInstanceOf(InvalidVehicleException.class)
        ...
        void shouldThrowExceptionWhenMotorbikeHasDoors() {
                ...
                // QUE DEBERIA HACER:
                // Debe lanzar una InvalidVehicleException porque las motos no pueden tener
                // puertas,
                // validando que el mensaje de error corresponda a este caso de negocio.
                assertThatThrownBy(() -> Vehicle.create(VehicleType.MOTORBIKE, "5678DFG", "Honda", "CBR", "Black", 2,
                                false, true))
                                .isInstanceOf(InvalidVehicleException.class)
        ...
        void shouldThrowExceptionWhenRequiredParametersAreNull() {
                // QUE HACE:
                // Intenta instanciar un coche enviando el tipo como null, y luego con la
                // matricula como null.
                // QUE DEBERIA HACER:
                // Debe lanzar InvalidVehicleException con mensajes de error descriptivos
                ...
                assertThatThrownBy(
                                () -> Vehicle.create(VehicleType.CAR, null, "Toyota", "Corolla", "Red", 4, false, true))
                                .isInstanceOf(InvalidVehicleException.class)
                                .hasMessageContaining("Invalid vehicle data: Plate can't be null");

                assertThatThrownBy(() -> Vehicle.create(VehicleType.CAR, "1234BCD", null, "Corolla", "Red", 4, false,
                                true))
                                .isInstanceOf(InvalidVehicleException.class)
                                .hasMessageContaining("Invalid vehicle data: Brand can't be null");

                assertThatThrownBy(
                                () -> Vehicle.create(VehicleType.CAR, "1234BCD", "Toyota", null, "Red", 4, false, true))
                                .isInstanceOf(InvalidVehicleException.class)
                                .hasMessageContaining("Invalid vehicle data: Model can't be null");

                assertThatThrownBy(() -> Vehicle.create(VehicleType.CAR, "1234BCD", "Toyota", "Corolla", null, 4, false,
                                true))
                                .isInstanceOf(InvalidVehicleException.class)
        ...
        void shouldThrowExceptionWhenStringParametersAreBlank() {
                assertThatThrownBy(() -> Vehicle.create(VehicleType.CAR, "1234BCD", "  ", "Corolla", "Red", 4, false,
                                true))
                                .isInstanceOf(InvalidVehicleException.class)
                                .hasMessageContaining("Invalid vehicle data: Brand can't be empty ( )");

                assertThatThrownBy(
                                () -> Vehicle.create(VehicleType.CAR, "1234BCD", "Toyota", "  ", "Red", 4, false, true))
                                .isInstanceOf(InvalidVehicleException.class)
                                .hasMessageContaining("Invalid vehicle data: Model can't be empty ( )");

                assertThatThrownBy(() -> Vehicle.create(VehicleType.CAR, "1234BCD", "Toyota", "Corolla", "  ", 4, false,
                                true))
                                .isInstanceOf(InvalidVehicleException.class)
        ...
        void shouldValidateSetters() throws InvalidVehicleException {
                // QUE HACE:
                // Crea un coche valido y luego intenta modificar la matricula a null mediante
                // setPlate(),
                // o intenta asignarle un sidecar mediante setHasSidecar(true).
                Vehicle vehicle = Vehicle.create(VehicleType.CAR, "1234BCD", "Toyota", "Corolla", "Red", 4, false,
                                true);

                // QUE DEBERIA HACER:
                // Las actualizaciones deben lanzar InvalidVehicleException porque violan las
                // reglas del dominio,
                // asegurando que no se pueda corromper el estado del objeto al actualizarlo.
                assertThatThrownBy(() -> vehicle.update(vehicle.getType(), null, vehicle.getBrand(), vehicle.getModel(),
                                vehicle.getColor(), vehicle.getNumDoors(), vehicle.getHasSidecar(), vehicle.isActive()))
                                .isInstanceOf(InvalidVehicleException.class)
                                .hasMessageContaining("Invalid vehicle data: Plate can't be null");

                assertThatThrownBy(() -> vehicle.update(vehicle.getType(), vehicle.getPlate(), vehicle.getBrand(),
                                vehicle.getModel(), vehicle.getColor(), vehicle.getNumDoors(), true,
                                vehicle.isActive()))
                                .isInstanceOf(InvalidVehicleException.class)
                                .hasMessageContaining("Cars do not have sidecar");
        }
        ...
        // @ParameterizedTest: Ejecuta el test una vez por cada valor proporcionado en
        // @ValueSource.
        // @ValueSource(strings): Proporciona cadenas de texto como parametros de
        // entrada.
        @ParameterizedTest
        ...
        void shouldNotThrowExceptionForValidModernPlates(String plate) {
                // QUE HACE:
                // Llama a validPlate con matriculas en formato moderno correcto (4 digitos + 3
                // consonantes).
                // QUE DEBERIA HACER:
                // No debe lanzar ninguna excepcion, lo que confirma que la matricula es valida.

                // assertDoesNotThrow: Verifica que la expresion lambda NO lanza ninguna
                // excepcion.
        ...
        void shouldThrowExceptionForInvalidPlateFormat(String plate) {
                // QUE HACE:
                // Llama a validPlate con matriculas que no cumplen ni el formato moderno ni el
                // antiguo.
                // QUE DEBERIA HACER:
                // Debe lanzar InvalidVehicleException con un mensaje indicando que el patron es
                // invalido.
        ...
        void shouldThrowExceptionWhenPlateIsBlank(String plate) {
                ...
                // QUE DEBERIA HACER:
                // Debe lanzar InvalidVehicleException indicando que el campo de matricula no
                // puede estar vacio.
                assertThatThrownBy(() -> Vehicle.validPlate(plate))
                                .isInstanceOf(InvalidVehicleException.class)
